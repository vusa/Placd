                ...
                <div class="dialog">
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="contactPhone"><g:message code="company.contactPhone.label" default="Contact Phone" /></label>
                                </td>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="contactEmail"><g:message code="company.contactEmail.label" default="Contact Email" /></label>
                                </td>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: companyInstance, field: 'owner', 'errors')}">
                                    <g:select name="owner.id" from="${com.placd.model.Recruiter.list()}" optionKey="id" value="${companyInstance?.owner?.id}"  />
                                </td>
                            </tr>
